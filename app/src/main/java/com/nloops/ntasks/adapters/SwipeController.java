...
public class SwipeController extends ItemTouchHelper.Callback {
  ...
  private void drawButtons(Canvas c, RecyclerView.ViewHolder viewHolder) {
    ...
    RectF leftButton = new RectF(itemView.getLeft() + margin, itemView.getTop() + margin,
        itemView.getLeft() + buttonWidthWithoutPadding, itemView.getBottom() - margin);
    p.setColor(Color.WHITE);
    c.drawRoundRect(leftButton, corners, corners, p);
    drawText("DONE", c, leftButton, p, Color.BLUE);

    RectF rightButton = new RectF(itemView.getRight() - buttonWidthWithoutPadding,
        itemView.getTop() + margin, itemView.getRight() - margin, itemView.getBottom() - margin);
    p.setColor(Color.WHITE);
    c.drawRoundRect(rightButton, corners, corners, p);
    drawText("DELETE", c, rightButton, p, Color.RED);
